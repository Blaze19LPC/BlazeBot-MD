...
const smsBye2 = () => { return `Se fue en busca de sus 7 negros` }
...
text5: `🇧​​​​​🇱​​​​​🇦​​​​​🇿🇪​​​​​🇧​​​​​🇴​​​​​🇹​​​​​-🇲​​​​​🇩​​​​​ - sᴜʙsᴄʀɪʙᴇᴛᴇ ᴇɴ ɴᴜᴇsᴛʀᴏ ᴄᴀɴᴀʟ ᴅᴇʟ ʏᴏᴜᴛᴜʙᴇ 🔔\nhttps://www.youtube.com/channel/UCt3MSRxA9lAaS1B3NWXNuZw`, 
text6: `✅ Actividad:`, 
text7: `👥 Usuarios:` }
...
const smsAntiLink2 = () => { return `🤨 eso no esta permitido idiota, Seras expulsado del grupo....` }
const smsAntiLink3 = () => { return `Te salvaste puta, no soy admin 🙄\n\n*[ LLAMADO A LOS ADMINS ]*` }
const smsAntiLink4 = () => { return `> El bot necesita ser admin para eliminar a esta imbecil` }
const smsAntiLink5 = () => { return `Eres un admin del grupo, así que no te prohibiré el uso de enlaces :)` }
const smsAntiLink6 = () => { return `Te salvarte perra, no soy admin no te puedo eliminar` }

//autosticker
const smsAutoSicker = () => { return `🤡 Ey, ¿Donde viste un sticker que dure tanto? 🤣. (Máximo 15 segundos)` }
...
const smsAutonivel9 = () => { return `*🥳 FELICIDADES LLEGASTE A UN NUEVO NIVEL 🎊*\n\n` }
...
const admin = () => { return `*⚠️ Tu no eres admin 🤡 solo los admins pueden usar este comando*` }
...
const group = () => { return `*⚠️ Pendejo este comando solo se puede usar en grupo*` }
...
const registra = () => { return `*[ 🔴 EY ALTO NO ESTAS REGISTRADO 🔴 ]*\n\nNO APARECES EN MI BASE DE DATOS ✋\n\nPara poder usar el bot necesita estar registrado:\n\n#reg nombre.edad` }
const limit = () => { return `*ᴅɪᴀᴍᴀɴᴛᴇ 💎 ᴜsᴀᴅᴏ*` }
const AntiNsfw = () => { return `*Los comando +18 estan desactivados*\nSi eres admin y quieres activarlos usar:\n• modocaliente on` }
const endLimit = () => { return `*😢 NO TIENES MAS DIAMANTE 💎*\n\nPuede comprar mas usando el comando: #buy` }
...
hd: `*𝘈𝘘𝘜𝘐 𝘛𝘐𝘌𝘕𝘌 𝘓𝘈 𝘐𝘔𝘈𝘎𝘌𝘕 𝘌N 𝘏𝘋*\n\nˢᶦ ˡᵃ ᶦᵐᵃᵍᵉⁿ ⁿᵒ ˢᵃˡᵉ ᵉⁿ ᴴᴰ ʳᵉˢᵖᵒⁿᵈᵉ ᵃ ˡᵃ ᶦᵐᵃᵍᵉⁿ ᶜᵒⁿ ᵉˡ ᶜᵒᵐᵃⁿᵈᵒ ᵈᵉ ⁿᵘᵉᵛᵒ`, 
...
text13: `*ʜᴏʟᴀ ᴇsᴛɪᴍᴀᴅᴏs ᴜsᴜᴀʀɪᴏs 👋🏻, ᴛᴇ ɪɴᴠɪᴛᴏ ᴀ ᴜɴɪʀᴛᴇ ᴀ ʟᴏs ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇ ʟᴀs ғᴀᴍɪʟᴀs 🇧​​​​​🇱​​​​​🇦​​​​​🇿🇪​​​​​🇧​​​​​🇴​​​​​🇹​​​​​-🇲​​​​​🇩​​​​​ ʏ ɴᴏᴠᴀʙᴏᴛ-ᴍᴅ, ᴘᴀʀᴀ ᴄᴏɴᴠɪᴠɪʀ ᴄᴏɴ ʟᴀ ᴄᴏᴍᴜɴɪᴅᴀᴅ :ᴠ*\n\n*➤ ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇʟ ʙᴏᴛ:*`, 
...
text19: `ˢᶦ ᵠᵘᶦᵉʳᵉˢ ᵠᵘᵉ ᵗᵘ ᵍʳᵘᵖᵒˢ ᵃᵖᵃʳᵉᶻᶜᵃⁿ ᵃᵠᵘᶦ ʰᵃᵇˡᵃ ᶜᵒⁿ ᵐᶦ ᶜʳᵉᵃᵈᵒʳ`, 
text20: (fb, md) => `╭─────────────┈⊷
│ \`COMO INSTALAR ESTE BOT?\`
╰┬────────────┈⊷
┌┤\`📌 REQUISITOS PARA LAS INSTALACION \`
┌┤❇️ _Dudas: wa.me/584147268853_
┌┤❇️ _Tutoríal: Próximamente será subido a Youtube_
┌┤❇️ _1 GB de almacenamiento_
┌┤❇️ _Termux: https://www.mediafire.com/file/3hsvi3xkpq3a64o/termux_118.apk/file_
┌┤❇️ _GitHub: https://github.com/Blaze19LPC/BlazeBot-MD_
...
* git clone https://github.com/Blaze19LPC/BlazeBot-MD && cd BlazeBot-MD && yarn && npm install
...
text22: `𝙴𝙻 𝚁𝙴𝙿𝙾𝚁𝚃𝙴 𝙵𝚄𝙴 𝙴𝙽𝚅𝙸𝙰𝙳𝙾 𝙰 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁, 𝙽𝙾𝚂 𝙲𝙾𝙽𝚃𝙰CTA𝚁𝙴𝙼𝙾𝚂 𝙲𝙾𝙽 𝚄𝚂𝚃𝙴𝙳 𝚂𝙸 𝙴𝚂 𝙽𝙴𝙲𝙴𝚂𝙰𝚁𝙸𝙾, 𝙳𝙴 𝚂𝙴𝚁 𝙵𝙰𝙻𝚂𝙾 𝚂𝙴𝚁𝙰 𝙸𝙶𝙽𝙾𝚁𝙰𝙳𝙾 𝚈 𝙱𝙻𝙾𝚀𝚄𝙴𝙰𝙳𝙾 𝙳𝙴𝙻 𝙱𝙾𝚃*`, 
...
text24: `*💖 ᵀᵃᵐᵇᶦᵉⁿ ᵖᵘᵉᵈᵉˢ ᶜᵒᵐᵖᵃʳᵗᶦʳ ˡᵒ ˢᶦᵍᵘᶦᵉⁿᵗᵉ ᶜᵒᵐᵒ ᴹᵘᵉˢᵗʳᵃ ᵈᵉ ᴬᵖᵒʸᵒ 💕*\n\n*❤ ᴬᵖᵒʸᵃʳ ᵉˡ ʳᵉᵖᵒˢᶦᵗᵒʳᶦᵒ ᶜᵒⁿ ᵘⁿᵃ ᵉˢᵗʳᵉˡˡᶦᵗᵃ, ᴳʳᵃᶜᶦᵃˢ 🙏💕*`, 
text25: `┗❴ ⚠ 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 ⚠ ❵┛\n\nᴇsᴛᴀ ᴘʀᴏʜɪʙɪᴅᴏ ᴇᴛɪǫᴜᴇᴛᴀʀ ᴀʟ ᴄʀᴇᴀᴅᴏʀ/🇩​​​​​🇪​​​​​🇸​​​​​🇦​​​​​🇷​​​​​🇷​​​​​🇴​​​​​🇱​​​​​🇱​​​​​🇦​​​​​🇩​​​​​🇴​​​​​🇷​​​​​ sɪ ᴛɪᴇɴᴇs ᴜɴᴀ sᴜɢᴇʀᴇɴᴄɪᴀs ʀᴇғᴇʀᴇɴᴛᴇ ᴀʟ ʙᴏᴛ ᴇsᴄʀɪʙɪʀʟᴇ ᴀ sᴜs ᴘʀɪᴠ`, 
text26: `*⚡ ¿Estas buscando un host de calidad y al ajuste de su bolsillo?*
...
\`🪄 Ahora con BlazeBot puedes crear logos personalizados :\`
#logos
...
ᴹᵃˢ ᶜᵒᵐᵃⁿᵈᵒˢ ᵉⁿ ᶠᵘᵗᵘʳᵃˢ ᵛᵉʳˢᶦᵒⁿᵉˢ, ᵠᵘᶦᵉʳᵉˢ ᵠᵘᵉ ᵃᵍʳᵉᵍᵘᵉ ᵃˡᵍᵘⁿ ᶜᵒᵐᵃⁿᵈᵒ ᵉⁿ ᵉˢᵖᵉᶜᶦᵃˡ ᵉˢᶜʳᶦᵇᶦʳˡᵉ ᵃ ᵐᶦ ᶜʳᵉᵃᵈᵒʳ`, 
text16: `\`🌐 REGLAS DEL BOT 🌐\`

*• No hacer spam de comandos*

Usar los comando cada 5 segundos, de lo contrario el bot se puede saturar, o numero del bot puede irse a support por spam.
...
*𝘚𝘦𝘳𝘷𝘪𝘤𝘪𝘰 𝘱𝘳𝘰𝘷𝘦𝘪𝘥𝘰 𝘱𝘰𝘳 Blaze𝘉𝘰𝘵*`, 
...
audio: `*⏳ＰＲＯＣＥＳＡＮＤＯ....*\n\n_ᴰᵉˢᶜᵃʳᵍᵃⁿᵈᵒ ˢᵘˢ ᵃᵘᵈᶦᵒ ᵃᵍᵘᵃʳᵈᵉ ᵘⁿ ᵐᵒᵐᵉⁿᵗᵒ ᵖᵒʳ ᶠᵃᵛᵒʳ_`, 
video: `*⏳ＰＲＯＣＥＳＡＮＤＯ....*\n\n_ᴰᵉˢᶜᵃʳᵍᵃⁿᵈᵒ ˢᵘˢ ᵛᶦᵈᵉᵒ ᵃᵍᵘᵃʳᵈᵉ ᵘⁿ ᵐᵒᵐᵉⁿᵗᵒ ᵖᵒʳ ᶠᵃᵛᵒʳ_`,
descargado: `_Descargando archivo aguarde un momento...._` }
...
text16: `*[ ⚠️ ] A QUIEN ELIMINO? ETIQUETA ALGUN USUARIO NO SOY ADIVINO 😯*`, 
...
text7: `𝙖 𝟰 𝙥𝙖𝙩𝙖𝙨 𝙢𝙞𝙚𝙣𝙩𝙧𝙖𝙨 𝙩𝙚 𝙜𝙚𝙢𝙞𝙖 𝙘𝙤𝙢𝙤 𝙪𝙣𝙖 𝙢𝙖𝙡𝙙𝙞𝙩𝙖 𝙥𝙚𝙧𝙧𝙖 "𝐀𝐚𝐚𝐡.., 𝐀𝐚𝐚𝐡𝐡, 𝐬𝐢𝐠𝐮𝐞, 𝐧𝐨 𝐩𝐚𝐫𝐞𝐬, 𝐧𝐨 𝐩𝐚𝐫𝐞𝐬.." 𝙮 𝙡𝙖 𝙝𝙖𝙨 𝙙𝙚𝙟𝙖𝙙𝙤 𝙩𝙖𝙣 𝙧𝙚𝙫𝙚𝙣𝙩𝙖𝙙𝙖 𝙦𝙪𝙚 𝙣𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙤𝙨𝙩𝙚𝙣𝙚𝙧 𝙣𝙞 𝙨𝙪 𝙥𝙧𝙤𝙥𝙞𝙤 𝙘𝙪𝙚𝙧𝙥𝙤 𝙡𝙖 𝙯𝙤𝙧𝙧𝙖!`, 
