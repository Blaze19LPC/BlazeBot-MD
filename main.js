...
//await delay(3 * 3000) 
//await conn.updateProfilePicture(numBot, { url: "https://telegra.ph/file/61f6c77b29431fd35de5e.jpg" })
...
let updatee = execSync('git remote set-url origin https://github.com/Blaze19LPC/BlazeBot-MD.git && git pull')
...
if (budy.includes(`BlazeBot`) || budy.includes(`Blazebot`)) {
m.react(`${pickRandom(['🌟', '👀', '🤑'])}`)}
...
//--------------------[ REPORTE/ERRORS ]-----------------------     
let e = String(err) 
conn.sendMessage("584147268853@s.whatsapp.net", { text: "Hola Creador/desarrollador, parece haber un error, por favor arreglarlo 🥲\n\n" + util.format(e), 
