...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Blaze19LPC/BlazeBot-MD\ncd BlazeBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/Blaze19LPC/BlazeBot-MD.git
...
┏╍┅┅┅╍⪻ 𝑩𝒍𝒂𝒛𝒆𝑩𝒐𝒕-𝑴𝑫 ⪼┅┅┅┅┅┓
┋❥ 𝐂𝐫𝐞𝐚𝐝𝐨𝐫 : Blaze19LPC
┋❥ 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : https://www.youtube.com/channel/UCt3MSRxA9lAaS1B3NWXNuZw
┋❥ 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 : https://www.facebook.com/BlazeOfficial19
┋❥ 𝐆𝐢𝐭𝐇𝐮𝐛 : https://github.com/Blaze19LPC
